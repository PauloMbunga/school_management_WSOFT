...
const Periodo = () => {
    ...
    async function handleSubmit(e){
        ...
        const data={
          ...
          try{
        await api.post('periodo',data);

        alert("Periodo criada com sucesso!");
       // setOpen(open)
       setDescription("");
...
<br></br>
        ...
        {open
          ...
          ? <div className="card card-w-title" >
                        <h1>DataTable</h1>
                        <DataTable scrollable={true} style={{'text-align':'center'}} value={items}  paginatorPosition="bottom" selectionMode="single" header="Lista de Periodos" paginator={true} rows={8}
