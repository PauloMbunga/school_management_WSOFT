...
<br></br>
        ...
        {open
          ...
          ? <div className="card card-w-title" >
                        <h1>DataTable</h1>
                        <DataTable scrollable={true} style={{'text-align':'center'}} value={items}  paginatorPosition="bottom" selectionMode="single" header="Lista de Cursos" paginator={true} rows={8}
